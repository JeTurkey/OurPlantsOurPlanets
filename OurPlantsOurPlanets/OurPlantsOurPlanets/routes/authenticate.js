        ...
        fs.readFile(path.join('D:/home/site/wwwroot' + '/views/header1.html'), function (err, data) {
            ...
            fs.readFile(path.join('D:/home/site/wwwroot' + '/views/weedEncyclopedia.html'), function (err, data) {
                ...
                connection.query(queryString, function (error, results, fields) {
                    ...
                    if (results.length > 6) {
                        htmlString = htmlString + '<div class="container collapse show" id="collapseOne"><div class="row d-flex">';
                    ...
                    connection.query(queryString, function (error, results, fields) {
                        ...
                        htmlString = htmlString + '<div class="container collapse" id="collapseTwo"><div class="row d-flex">';
                        var divNumber = 0;
                        for (var i = 0; i < results.length; i++) {
                            if (Math.ceil((i + 1) / 6) > divNumber) {
                                divNumber = divNumber + 1;
                        ...
                        htmlString = htmlString + '</div></div>';
                        if (results.length > 6) {
                            htmlString = htmlString + '<div class="container row mt-5 collapse" id="collapseTwo"><div class="col text-center"><div class="block-27"><ul>';
                            for (var j = 0; j < Math.ceil(results.length / 6); j++) {
                                if (j == 0) {
                                    htmlString = htmlString + '<li class="number  justify-content-center align-items-center active"> ';
                                } else {
